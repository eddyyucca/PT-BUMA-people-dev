...
<nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="">Data Departement</li>
        </ol>
    </nav>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="container">
                    <a href="<?= base_url('admin/create_departement') ?>" class="btn btn-success"><i class="fas fa-plus-circle"></i> Tambah Departemen</a>
                    <hr>
                </div>
                <?php
