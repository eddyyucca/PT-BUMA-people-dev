                    ...
                    <tbody>
                        ...
                        foreach ($data as $x) { ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?= base_url('admin/delete_kompetensi/') . $x->id_kom; ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                    <a href="<?= base_url('admin/edit_kompetensi/') . $x->id_kom; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php   } ?>
                    </tbody>
