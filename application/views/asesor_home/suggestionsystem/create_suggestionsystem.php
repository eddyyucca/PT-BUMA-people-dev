                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="card">
                                            <div class="card-header py-3">
                                                <h6 class="m-0 font-weight-bold ">Add Suggestion System</h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="container-fluid">
                                                        <?= validation_errors() ?>
                                                        <form action="<?= base_url('asesor/proses_tambah_suggestionsystem')  ?>" method="POST" enctype="multipart/form-data">
                                                            <table class="table">
                                                                <tr>
