    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="container">
                    <a href="<?= base_url('asesor/create_task_kompetensi') ?>" class="btn btn-success"><i class="fas fa-plus-circle"></i> Tambah Kompetensi</a>
                    <hr>
                </div>
                <?php
                    ...
                    <tbody>
                        ...
                        foreach ($data as $x) { 
                            if ($x->date_kom == true) { ?>
                                ...
                                <td align="center">
                                    <a href="<?= base_url('asesor/view_taskkompetensi/') . $x->id_jab; ?>" class="btn btn-success">View Kompetensi</a>
                                </td>
                                <td align="center">
                                    <a href="<?= base_url('asesor/delete_taskkompetensi/') . $x->id_kom_user; ?>" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                         <?php   }else{
