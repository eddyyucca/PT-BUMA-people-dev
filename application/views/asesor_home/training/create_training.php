                ...
                <div class="card-body">
                    <div class="row">
                        <div class="container-fluid">
                            <?= validation_errors() ?>
                            <form action="<?= base_url('asesor/proses_tambah_training')  ?>" method="POST"
                                enctype="multipart/form-data">
                                <table class="table">
                                    <div class="form-group">
                                        <label>Yang Melakukan</label>
                                        <select name="karyawan" class="form-control  selectpicker"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            <input name="sertifikat_training" class="form-control" type="file"
