    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="container">
                    <a href="<?= base_url('admin/create_training_opt') ?>" class="btn btn-success"><i class="fas fa-plus-circle"></i> Tambah Training Optional</a>
                    <hr>
                </div>
                <?php
                    ...
                    <tbody>
                        ...
                        foreach ($data as $x) { ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?= base_url('admin/delete_training_opt/') . $x->id_topt; ?>" class="btn btn-danger"> <i class="fas fa-trash"></i></a>
                                    <a href="<?= base_url('admin/edit_training_opt/') . $x->id_topt; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php   } ?>
                    </tbody>
