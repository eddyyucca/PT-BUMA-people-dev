                    ...
                    <tbody>
                        ...
                        foreach ($data as $x) { ?>
                            <tr>
                                ...
                                <td><?= $x->nama_sec; ?></td>
                                <td align="center">
                                    <a href="<?= base_url('admin/delete_section/') . $x->id_sec; ?>" class="btn btn-danger"> <i class="fas fa-trash"></i></a>
                                    <a href="<?= base_url('admin/edit_section/') . $x->id_sec; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php   } ?>
                    </tbody>
