                    ...
                    <tbody>
                        ...
                        foreach ($data as $x) { ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?= base_url('admin/delete_jab/') . $x->id_jab; ?>" class="btn btn-danger"> <i class="fas fa-trash"></i></a>
                                    <a href="<?= base_url('admin/edit_jabatan/') . $x->id_jab; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php   } ?>
                    </tbody>
